 ...
 * the Flash button. Rendered on the light band, because a wall of text on the
 * dark photograph is where reading goes to die.
 */
export default function DeviceIntro({ intro, shop }: { intro: Intro; shop?: string }) {
  const words = intro.headline.trim().split(' ');
  const accent = words.pop();

  return (
    <section className="band-light w-full py-16 md:py-20">
